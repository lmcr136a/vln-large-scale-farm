...
export LD_LIBRARY_PATH=/home/nahyeon/box/vln-large-scale-farm/glim_ws/install/glim_localizer/lib/glim_localizer:$LD_LIBRARY_PATH
...
ros2 run glim_ros glim_rosnode \
  --ros-args \
  -p config_path:=/home/nahyeon/box/vln-large-scale-farm/glim_ws/config_indoor \
