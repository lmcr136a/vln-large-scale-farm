...
tmux send-keys -t $SESSION:1 "bash $SCRIPT_DIR/launch_slam.sh" C-m
...
tmux send-keys -t $SESSION:4 "python3 tools_control_panel/mapping/save_map_glim_groundseg.py" C-m
