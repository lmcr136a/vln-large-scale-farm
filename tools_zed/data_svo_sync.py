...
def main():
    ...
    print("ZED running L R")
    rec_L = ZEDSVORecorder(serial_number=48335070, name="L", base_path=base_path, sync_time=args.sync_time)
    rec_R = ZEDSVORecorder(serial_number=49537850, name="R", base_path=base_path, sync_time=args.sync_time)
