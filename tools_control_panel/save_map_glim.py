...
class ContinuousPointCloudMapper(Node):
    ...
    def __init__(self):
        ...
        self.pc_sub     = self.create_subscription(PointCloud2, '/glim_ros/map', self.pc_callback, qos)
        self.path_sub   = self.create_subscription(Path, '/glim_ros/odom', self.path_callback, qos)
